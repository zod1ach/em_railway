...
const PARAMS: ParamDef[] = [
  ...
  { key: "mu_r_real", label: "\u00b5r (real)", unit: "", default: 100 },
  { key: "mu_r_imag", label: "\u00b5r (imag)", unit: "", default: -50 },
...
export function HvacMagnetic() {
  ...
  async function calculate() {
    ...
    setError("");
    try {
      const res = await api.hvacMag(values);
      setData(res);
    } catch (e: any) {
      setError(e.message);
    } finally {
    ...
    <div className="space-y-8">
      ...
      <Card>
        <div className="flex items-center justify-between mb-6">
          ...
          <span className="text-[11px] text-muted font-mono">HVAC-MA</span>
        </div>
